...
class AppUserMapper {
  ...
  static AppUser fromFirestore({
    ...
    return AppUser(
      ...
      status: _userStatusFromString(data['status'] as String?),
  ...
  static AccountType? _accountTypeFromString(String? value) {
    return switch (value) {
      ...
      _ => throw FormatException('Tipo de conta inválido no Firestore: $value'),
    };
  }
  ...
  static DateTime? _dateTimeFromFirestore(Object? value) {
    ...
    throw FormatException('Data inválida recebida do Firestore: $value');
  }
}
